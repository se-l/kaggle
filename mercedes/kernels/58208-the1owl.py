...
train = pd.read_csv(os.path.join(projectDir, r'input/train.csv'))
test = pd.read_csv(os.path.join(projectDir, r'input/test.csv'))
...
sub.to_csv(os.path.join(projectDir,r'subm/stacked-models-{}.csv'.format(
